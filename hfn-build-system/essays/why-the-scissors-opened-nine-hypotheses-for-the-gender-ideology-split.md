...
excerpt: >-
  The gender ideology gap runs 15 to 50 points across the developed
  world — yet it does not exist in the Middle East, India,
  Sub-Saharan Africa, or Indonesia. African women have the highest
  workforce participation on Earth but no ideology gap. This article
  traces the split across five continents, from the demographic shock
  of two world wars through nine causal hypotheses, tested against
  three falsification tools: the Nordic Paradox, the developing world,
  and the war itself.
share_summary: >-
  The gender ideology split runs 15–50 points across the developed
  world and is absent across the rest. African women work more than
  anyone — and show no gap. The wars, the pill, the algorithms, the
  moral foundations. Nine hypotheses, five continents, three
  falsification tools.
signal: ''
sources:
  - "The Righteous Mind"
