...
excerpt: >-
  Microsoft's AI chief predicts virtually all white-collar tasks will be
  automated within 18 months. South Korea's fertility rate is 0.72. Japan
  sells more adult nappies than baby nappies. Tesla's Optimus robot targets
...
Moreover, the economic case for mass immigration is already weaker than its proponents claim — and the numbers are now specific enough to be devastating. A 2023 University of Amsterdam study using microdata on all 17 million Dutch residents found that the average asylum seeker costs the treasury €475,000 over their lifetime; immigrants from the Horn of Africa cost €606,000 per person. Total cost of immigration to the Netherlands between 1995 and 2019: approximately €17 billion per year. Denmark's Ministry of Immigration reported that non-Western immigration cost the Danish state 31 billion DKK (€4.2 billion) in 2018 — in a country of fewer than six million people. The argument that immigration is necessary to sustain the welfare state is, in these cases, arithmetically backwards. The immigrants arriving cost more than they contribute. Immigration is not filling the demographic hole. It is making it deeper.
